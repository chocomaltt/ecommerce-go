...
type fakeKratos struct{ registerErr, loginErr, whoamiErr, logoutErr error }

func (f fakeKratos) Register(context.Context, string, string) error { return f.registerErr }
