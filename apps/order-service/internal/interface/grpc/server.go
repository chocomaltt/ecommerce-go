...
func New(identity *identityusecase.Service) *Server { return &Server{identity: identity} }
func (s *Server) GetCaller(ctx context.Context, _ *orderv1.GetCallerRequest) (*orderv1.GetCallerResponse, error) {
	...
	return &orderv1.GetCallerResponse{UserId: actor.UserID, Email: actor.Email, CallerService: actor.CallerService}, nil
}
...
func Authenticate(expected string, verifier port.ActorVerifier, contexts port.Context) grpc.UnaryServerInterceptor {
	return func(ctx context.Context, req any, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (any, error) {
		...
		return handler(contexts.WithActor(ctx, port.Actor{UserID: actor.UserID, Email: actor.Email, CallerService: "edge-api"}), req)
	}
}
